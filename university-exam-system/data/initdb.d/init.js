...
if (students.countDocuments() === 0) {
    ...
    students.insertMany([
        { _id: student1, name: "Aarav Patel", email: "aarav.patel@example.com", course_ids: [course1], exam_ids: [exam1] },
        { _id: student2, name: "Ishita Mehta", email: "ishita.mehta@example.com", course_ids: [course2], exam_ids: [exam2] }
    ]);
